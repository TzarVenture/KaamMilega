            ...
            <div className="space-y-4 relative">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full px-10 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-km-primary/20 focus:border-km-primary outline-none"
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                    />
                </div>

                <div className="min-h-50 max-h-75 overflow-y-auto space-y-1 pr-1 custom-scrollbar">
                    {loading && (
                    ...
                    {!loading && results.map((skill) => (
                        ...
                        >
                            ...
                            <CheckCircle2 size={16} className="text-km-primary opacity-0 group-hover:opacity-100 transition-opacity" />
                        </button>
                    ))}
